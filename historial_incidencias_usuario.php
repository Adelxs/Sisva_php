...
<head>
    ...
    <style>
        /* Estilos unificados del Panel de Gestión */
        * { 
        ...
        /* Estilo de la tabla profesional */
        table {
...
<body>
    ...
    <div class="container">
        ...
        <div class="user-info">
            Usuario: <strong><?php echo htmlspecialchars($codigo_usuario); ?></strong>
        </div>
        ...
        <button class="btn-volver" type="button" onclick="window.location.href='panel_usuario.php'">
            VOLVER AL PANEL
        </button>
    </div>
