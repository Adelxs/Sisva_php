...
<head>
    <meta charset="UTF-8">
    <title>Mis Reportes - Validador</title>
    <style>
        /* Estilos unificados con el Panel de Gestión */
        * { 
        ...
        /* Contenedor con alineación exacta */
        .container {
            max-width: 1228px;
            width: 95%;
...
<body>
    ...
    <div class="container">
        ...
        <div class="user-info">
            Validador: <strong><?php echo htmlspecialchars($codigo_usuario); ?></strong>
        </div>
        ...
        <button class="btn-volver" type="button" onclick="window.location.href='panel_validador.php'">
            VOLVER AL PANEL
        </button>
    </div>
    ...
    async function cargarReportes() {
        ...
        try {
            ...
            data.reportes.forEach(repo => {
                ...
                const fechaLocal = new Date(repo.Fecha).toLocaleString('es-CL');
