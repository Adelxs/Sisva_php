...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="logo">Panel Administrador </br> <p class="rol">Rol: Administrador</p></div>
        <ul>
    ...
    <div class="botones-incidencia">
        ...
        <button onclick="window.location.href='panel_administrador.php'" class="inci">VOLVER AL PANEL</button>
