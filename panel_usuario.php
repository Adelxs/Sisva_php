...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="logo">Panel Usuario </br> <p class="rol">Rol: Usuario</p></div>
        <ul>
...
<button onclick="window.location.href='agregar_reportes_usuario.php'" class="inci">REPORTAR INCIDENCIA</button>
        <button onclick="window.location.href='historial_incidencias_usuario.php'" class="inci">HISTORIAL DE INCIDENCIAS</button>
        <button onclick="window.location.href='perfil_usuario.php'" class="inci">MI PERFIL</button>
    </div>
